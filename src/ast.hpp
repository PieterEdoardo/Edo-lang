...
using Expression = std::variant<NumberExpression, StringExpression, TypeExpression, IdentifierExpression, BinaryExpression, UnaryExpression, CastExpression, CallExpression>;
